...
namespace SearchServer.Manager {
    public class LuceneManager {
        private readonly ILogger<LuceneManager> _logger;
        public LuceneManager(ILogger<LuceneManager> logger) {
            _logger = logger;
        }
        public async Task WriteDocumentAsync(Message message) {
            using (var writer = GetIndexWriter(message.GroupId)) {
                ...
                try {
                    ...
                    _logger.LogInformation($"{message.GroupId},{message.MessageId},{message.Content}");
                }
            }
        }
