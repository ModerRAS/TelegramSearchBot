...
namespace TelegramSearchBot.Test.Helpers
{
  ...
  ""Logging"": {
    ...
    internal class TestEnvService : IEnvService
    {
        ...
        public string BotToken => _configuration["Telegram:BotToken"] ?? "test_bot_token_123456789";
        
        public long AdminId => long.TryParse(_configuration["Telegram:AdminId"], out var adminId) ? adminId : 123456789;
    }
