...
namespace TelegramSearchBot.Service {
    ...
    public class SendService {
        ...
        public static List<string> ConvertToList(IEnumerable<Common.DO.Message> messages) {
        ...
        public string GenerateMessage(List<Common.DO.Message> Finded, SearchOption searchOption) {
            string Begin;
        ...
        public async Task ExecuteAsync(SearchOption searchOption, List<Common.DO.Message> Finded) {
